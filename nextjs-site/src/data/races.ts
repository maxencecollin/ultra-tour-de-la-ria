...
export const races: Race[] = [
  ...
  },
  {
    ...
    longDescription: 'Le Relais Duo permet de partager l\'aventure du 80km en equipe de deux. Le premier relayeur effectue 50km, ou le second prend le relais pour les 30km restants. Une experience de cohesion unique avec traversee bateau.',
    startTime: '08:00',
    startLocation: 'Salle Emeraude, Locoal-Mendon',
    price: 100,
    maxParticipants: 100,
    ...
    gpxTracks: [
      {
        id: 'relais-a',
        name: 'Segment A - Relayeur 1 (50km)',
    ...
    segments: [
      {
        ...
        endLocation: 'Zone de relais (km 50)',
      },
      {
        id: 'segment-b',
        name: 'Segment B',
        ...
        distance: 30,
        elevation: 700,
        startLocation: 'Zone de relais (km 50)',
